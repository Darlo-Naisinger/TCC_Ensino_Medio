<html>
    <head>
        ...
        if ($_SESSION['funcao'] == 'Admin') {
            header('location:Banco_horas_adm.php');
        }
    ...
    <body id="corpo">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-6 " id="divbancohora" >
                    ...
                    <form action="Banco_horas_funci.php"   method="POST">
        ...
        if (!empty($_POST['data1'])) {
            try {
                ...
                $consulta = $pdo->query("SELECT * FROM ponto WHERE (data BETWEEN '$data1' AND '$data2') AND
              (id_usuarios = " . $_SESSION['id_usuario'] . ")");

                echo"<table id='table' class='table table-hover' style ='whidth:100%' align='center'>"
                . "<tr align='center'>"
                . "<th>Data</th>"
                . "<th>Entrada</th>"
                . "<th>Saída</th>"
